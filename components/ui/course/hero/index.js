...
export default function CourseHero({ title, desc, image, hasOwner }) {
    ...
    <section>
      <div className="relative bg-white overflow-hidden">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <Image
            layout="fill"
            className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={image} alt={title} />
        </div>
      </div>
    </section>
  )
